...
export const NAV_ITEMS: NavItem[] = [
  ...
  { path: 'ifta-label', name: 'IftaLabel', desc: 'In-field top label', group: 'Form' },
  { path: 'editor', name: 'Editor', desc: 'Rich-text editor', group: 'Form' },
  ...
  { path: 'virtual-scroller', name: 'VirtualScroller', desc: 'Standalone virtual list', group: 'Display' },
  { path: 'terminal', name: 'Terminal', desc: 'Command-line interface', group: 'Display' },
  { path: 'ripple', name: 'Ripple', desc: 'Click ripple directive', group: 'Display' },
  ...
  { path: 'mega-menu', name: 'MegaMenu', desc: 'Multi-column mega menu', group: 'Navigation' },
  ...
  { path: 'org-chart', name: 'OrgChart', desc: 'Top-down hierarchy of node cards', group: 'Display' },
  { path: 'dynamic-dialog', name: 'DynamicDialog', desc: 'Open components in a modal imperatively', group: 'Overlay' },
  { path: 'animate-on-scroll', name: 'AnimateOnScroll', desc: 'Reveal-on-scroll directive', group: 'Utilities' },
  { path: 'style-class', name: 'StyleClass', desc: 'Toggle classes on a target', group: 'Utilities' },
  { path: 'deferred-content', name: 'DeferredContent', desc: 'Lazy-render on scroll-in', group: 'Utilities' },
  { path: 'focus-trap', name: 'FocusTrap', desc: 'Cycle Tab focus within a region', group: 'Utilities' }
];
