...
@Component({
  selector: 'app-dynamic-dialog-doc',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [ButtonComponent, DocPageComponent, DocTabComponent, ThemingNotesComponent, ApiTableComponent, DocSectionComponent],
  template: `
    <doc-page slug="dynamic-dialog"><doc-tab label="Features">
      <doc-section title="Open a component & await its result" [code]="code">
...
export class DynamicDialogDocComponent {
  readonly apiProps = [
