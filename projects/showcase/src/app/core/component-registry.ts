...
export const COMPONENTS: ComponentDoc[] = [
  ...
  { slug: 'timeline', name: 'Timeline', group: 'Display', icon: '⏱', summary: 'Event sequence with markers' , ready: true },
  { slug: 'org-chart', name: 'OrgChart', group: 'Display', icon: '🌳', summary: 'Top-down hierarchy of node cards', ready: true },
  { slug: 'data-view', name: 'DataView', group: 'Display', icon: '▤', summary: 'List / grid of items (virtualized)', virtualized: true , ready: true },
  ...
  { slug: 'virtual-scroller', name: 'VirtualScroller', group: 'Display', icon: '≣', summary: 'Standalone virtual list', virtualized: true , ready: true },
  ...
  { slug: 'tree', name: 'Tree', group: 'Navigation', icon: '🌲', summary: 'Hierarchical tree (virtualized)', complex: true, virtualized: true, ready: true },
  { slug: 'order-list', name: 'OrderList', group: 'Navigation', icon: '↕', summary: 'Reorderable list (virtualized)', virtualized: true , ready: true },
  { slug: 'pick-list', name: 'PickList', group: 'Navigation', icon: '⇄', summary: 'Dual-list transfer (virtualized)', virtualized: true , ready: true },
  { slug: 'paginator', name: 'Paginator', group: 'Navigation', icon: '⏭', summary: 'Standalone pager' , ready: true },
